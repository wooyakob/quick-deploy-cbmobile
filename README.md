...
Give the key a name, "simple-retail", and select Organization Owner or Project Owner for key permissions, depending on where you are generating the key from.
